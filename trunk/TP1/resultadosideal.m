...
for letra = 1:27
    for tipografia = 1:3
        for mayuscula = 1:2
            ...
            pgmWrite(l, ['./resultados_ideal',separator,nombreBase,'_0.pgm']);
            pgmWrite(r1, ['./resultados_ideal',separator,nombreBase,'_1.pgm']);
            pgmWrite(r2, ['./resultados_ideal',separator,nombreBase,'_2.pgm']);
            pgmWrite(r3, ['./resultados_ideal',separator,nombreBase,'_3.pgm']);
            pgmWrite(r4, ['./resultados_ideal',separator,nombreBase,'_4.pgm']);
            pgmWrite(r5, ['./resultados_ideal',separator,nombreBase,'_5.pgm']);
        end
    end
end